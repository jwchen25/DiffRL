...
def train_procedure(model_cfg, crystal_preprocessor, matbench_datasets_subset, 
                    ...
                    use_scaler=True, epochs=800, batch_size=64, epochs_classification=800):
...
if __name__ == '__main__':
    ...
    if model_name == 'coGN':
        mb = train_procedure(model_default, KNNAsymmetricUnitCell(24),
                             ...
                             use_scaler=True,
                             epochs=800, epochs_classification=800,
                             batch_size=64)
        ...
        mb = train_procedure(model_default_nested, VoronoiAsymmetricUnitCell(1e-6),
                             ...
                             use_scaler=True,
                             epochs=600, epochs_classification=50,
                             batch_size=64)
        ...
        for key, values in mb.scores.items():
            ...
            if key not in ["matbench_mp_is_metal"]:
                ...
                class_metrics = "rocauc"
                print(key, values[class_metrics]["mean"],  values[class_metrics]["std"])